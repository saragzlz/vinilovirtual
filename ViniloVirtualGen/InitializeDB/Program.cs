...
static void Main (string[] args)
{
        ...
        System.Console.WriteLine ("A new database called: ViniloVirtualGenNHibernate will be created (the previous information will be deleted).");
        System.Console.WriteLine ("-----------------------------------------------------------------------------");
        ...
        try
        {
                CreateDB.Create ("ViniloVirtualGenNHibernate", "nhibernateUser", "nhibernatePass");
