...
void SeguirComunidad (int p_Comunidad_OID, System.Collections.Generic.IList<int> p_usuario_OIDs);

void AbandonarComunidad (int p_Comunidad_OID, System.Collections.Generic.IList<int> p_usuario_OIDs);
}
}
