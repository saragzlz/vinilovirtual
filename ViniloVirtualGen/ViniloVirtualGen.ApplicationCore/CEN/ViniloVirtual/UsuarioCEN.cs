...
namespace ViniloVirtualGen.ApplicationCore.CEN.ViniloVirtual
{
        ...
        public partial class UsuarioCEN
        {
                ...
                private IArtistaRepository _ArtistaRepository;
                ...
                public UsuarioCEN(IUsuarioRepository _IUsuarioRepository, IAlbumRepository _IAlbumRepository)
                {
                        this._IUsuarioRepository = _IUsuarioRepository;
                        this._IAlbumRepository = _IAlbumRepository;
                }

                public UsuarioCEN(IUsuarioRepository _IUsuarioRepository, IArtistaRepository _IArtistaRepository)
                {
                        this._IUsuarioRepository = _IUsuarioRepository;
                        this._ArtistaRepository = _IArtistaRepository;
                }
                ...
                public void Modify(string p_Usuario_OID, string p_nombre, String p_pass, Nullable<DateTime> p_fechaNac, ViniloVirtualGen.ApplicationCore.Enumerated.ViniloVirtual.GeneroUsuarioEnum p_genero, ViniloVirtualGen.ApplicationCore.Enumerated.ViniloVirtual.EstadoUsuarioEnum p_estado, string p_imagen, string p_apellido, ViniloVirtualGen.ApplicationCore.Enumerated.ViniloVirtual.TipoUsuarioEnum p_tipo, System.Collections.Generic.IList<ViniloVirtualGen.ApplicationCore.EN.ViniloVirtual.ArtistaEN> artista_favoritos, System.Collections.Generic.IList<ViniloVirtualGen.ApplicationCore.EN.ViniloVirtual.AlbumEN> album, System.Collections.Generic.IList<ViniloVirtualGen.ApplicationCore.EN.ViniloVirtual.AlbumEN> albumfav)
                {
                        UsuarioEN usuarioEN = null;
                        ...
                        usuarioEN.Apellido = p_apellido;
                        usuarioEN.Tipo = p_tipo;
                        usuarioEN.Artista_favoritos = artista_favoritos;
                        usuarioEN.Album_favoritos = albumfav;
                        usuarioEN.Album = album;
