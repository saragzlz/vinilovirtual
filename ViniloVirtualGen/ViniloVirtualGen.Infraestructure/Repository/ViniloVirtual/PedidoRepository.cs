...
public int New_ (PedidoEN pedido)
{
        ...
        try
        {
                ...
                if (pedido.Usuario != null) {
                        ...
                        pedidoNH
                        .Usuario = (ViniloVirtualGen.ApplicationCore.EN.ViniloVirtual.UsuarioEN)session.Load (typeof(ViniloVirtualGen.ApplicationCore.EN.ViniloVirtual.UsuarioEN), pedido.Usuario.Id);
